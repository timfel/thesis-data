...
suite.add('Unconstrained Read', function() {
    sumObj.a + sumObj.b + sumObj.c + sumObj.d + sumObj.e
}).add('Properties Read', function() {
    sumObj2.a + sumObj2.b + sumObj2.c + sumObj2.d + sumObj2.e
}).add('Constrained Read', function() {
    constrainedSumObj.a + constrainedSumObj.b +
        constrainedSumObj.c + constrainedSumObj.d + constrainedSumObj.e
}).add('Constrained Read (disabled)', function() {
    constraint.disable();
    constrainedSumObj.a + constrainedSumObj.b +
        constrainedSumObj.c + constrainedSumObj.d + constrainedSumObj.e
}).add('Constrained Read (disabled, unconstrained)', function() {
    constraint.disable();
